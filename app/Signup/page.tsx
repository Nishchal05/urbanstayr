...
export default function SignupPage() {
  ...
  const handleChange = ( e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement> ) => { console.log(form); setForm({ ...form, [e.target.name]: e.target.value }); 
};
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 px-8 py-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Join thousands finding &amp; listing spaces</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="partner">🏠 Partner — I list my property</option>
                  <option value="client">🔍 Client — I&apos;m seeking PG / Hostel / Flat</option>
                </select>
              ...
              {form.role && (
                <p className={`mt-2 text-xs font-medium flex items-center gap-1 ${
                  ...
                  {form.role === "partner"
                    ? "You'll list and manage your properties"
                    : "You'll browse PGs, hostels & flats"}
                </p>
              )}
            </div>
